!(function (e, t) {
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && S.test(e) ? C(e) : e || [], !1)
          .length;
      },
    });
  var N,
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && k(t, "input") && ke(t, "click", Ee),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && k(t, "input") && ke(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
          ...
          (l = s[c]),
            he.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : _(l.textContent.replace(Ne, ""), l, u));
    }
    return n;
  }
  function Pe(e, t, n) {
    ...
    C.fn.extend({
      ...
      toggleClass: function (r, t) {
        ...
        return "boolean" == typeof t && s
          ...
          ? this.each(function (e) {
              C(this).toggleClass(r.call(this, e, kt(this), t), t);
            })
          : this.each(function () {
              var e, t, n, i;
              if (s)
                ...
                (void 0 !== r && "boolean" != o) ||
                  ((e = kt(this)) && Y.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, i = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + St(kt(t)) + " ").indexOf(i))
            return !0;
        return !1;
      },
    });
  ...
  (function (t) {
    ...
    (a.data = function (e, t, n) {
      ...
      if (t && "object" == typeof t && 2 === arguments.length) {
        for (o in ((i = a.hasData(e) && k.call(this, e)), (r = {}), t))
          o !== y(o)
    ...
    (a.event.props = []),
      ...
      (a.event.fix = function (e) {
        ...
        return (t = N.call(this, e)), i && i.filter ? i.filter(t, e) : t;
      }),
  ...
  (function (e, t) {
    ...
    p(document).on(
      ...
      (p.fn[o] = c._jQueryInterface),
      (p.fn[o].Constructor = c),
          ...
          (e.toggle = function () {
            ...
            !r ||
              ((e = this._element.querySelector(y)) &&
                ("radio" === e.type &&
                  (e.checked && this._element.classList.contains(m)
                    ? (n = !1)
                    : (t = r.querySelector(".active")) && p(t).removeClass(m)),
                n &&
              ...
              this._element.hasAttribute("disabled") ||
                ...
                n && p(this._element).toggleClass(m));
          }),
          (e.dispose = function () {
    ...
    p(document)
      ...
      (p.fn[f] = b._jQueryInterface),
      (p.fn[f].Constructor = b),
        ...
        return (
          ...
          (e.to = function (e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
              if (this._isSliding)
                p(this._element).one(D, function () {
                  return t.to(e);
                });
              else {
          ...
          (e._getConfig = function (e) {
            return (e = l(l({}, T), e)), g.typeCheckConfig(_, e, C), e;
          }),
          ...
          (e._addTouchEventListeners = function () {
            ...
            this._touchSupported &&
              ((e = function (e) {
                n._pointerEvent && j[e.originalEvent.pointerType.toUpperCase()]
          ...
          (o._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new o(this, t)), p(this).data(w, e)),
                "number" == typeof i)
              )
                e.to(i);
    ...
    p(document).on(
      ...
      (p.fn[_] = O._jQueryInterface),
      (p.fn[_].Constructor = O),
      (p.fn[_].noConflict = function () {
        return (p.fn[_] = E), O._jQueryInterface;
      });
    var L = "collapse",
      I = "bs.collapse",
      q = p.fn[L],
      ...
      W = (function () {
        ...
        return (
          ...
          (e.show = function () {
            ...
            this._isTransitioning ||
              ...
              (this._parent &&
                ...
                (e = null),
              (e &&
                (t = p(e).not(this._selector).data(I)) &&
                t._isTransitioning) ||
                ...
                n.isDefaultPrevented() ||
                  ...
                  p(this._element).removeClass(M).addClass(F),
                  ...
                  for (var r = 0; r < i; r++) {
                    ...
                    null !== s &&
                      (p([].slice.call(document.querySelectorAll(s))).hasClass(
                        ...
                        p(o).addClass(B).attr("aria-expanded", !1));
                  }
                this.setTransitioning(!0);
                this._element.style[n] = "";
          ...
          (e._getConfig = function (e) {
            return (
              ((e = l(l({}, P), e)).toggle = Boolean(e.toggle)),
              g.typeCheckConfig(L, e, H),
              e
            );
          }),
    ...
    p(document).on("click.bs.collapse.data-api", Q, function (e) {
      ...
      (p.fn[L] = W._jQueryInterface),
      (p.fn[L].Constructor = W),
      (p.fn[L].noConflict = function () {
        return (p.fn[L] = q), W._jQueryInterface;
      });
    var U =
    ...
    function ee(e) {
      return 11 === e ? J : (10 !== e && J) || Z;
    }
    function te(e) {
      if (!e) return document.documentElement;
      for (
        var t = ee(10) ? document.body : null, n = e.offsetParent || null;
    ...
    function ie(e, t) {
      ...
      if ((e !== l && t !== l) || i.contains(r))
        return "BODY" === (a = (s = l).nodeName) ||
          ("HTML" !== a && te(s.firstElementChild) !== s)
          ? te(l)
          : l;
      var u = ne(e);
    ...
    function ae(e) {
      ...
      return { height: se("Height", t, n, i), width: se("Width", t, n, i) };
    }
    var le = function (e, t) {
        if (!(e instanceof t))
    ...
    function pe(e) {
      ...
      var r,
        ...
        s = "HTML" === e.nodeName ? ae(e.ownerDocument) : {},
    ...
    function ge(e, t, n) {
      ...
      return (
        ...
        !r &&
          o &&
          ((d = parseFloat(u.marginTop, 10)),
          (h = parseFloat(u.marginLeft, 10)),
          (p.top -= c - d),
          (p.bottom -= c - d),
          (p.left -= f - h),
          (p.right -= f - h),
    ...
    function ye(e, t, i, n, r, o) {
      ...
      var a = ve(i, n, s, r),
        ...
        u = Object.keys(l)
          .map(function (e) {
            return de({ key: e }, l[e], { area: (t = l[e]).width * t.height });
            var t;
          })
          .sort(function (e, t) {
    ...
    function Te(e, n, t) {
      return (
        (void 0 === t
          ...
          e.enabled &&
            V(t) &&
            ((n.offsets.popper = he(n.offsets.popper)),
            (n.offsets.reference = he(n.offsets.reference)),
            (n = t(n, e)));
        }),
        n
      );
    ...
    function De(e, t, n, i) {
      (n.updateBound = i),
        ke(e).addEventListener("resize", n.updateBound, { passive: !0 });
      var r = K(e);
      return (
        (function e(t, n, i, r) {
    ...
    var Le = U && /Firefox/i.test(navigator.userAgent);
    function Ie(e, t, n) {
      var i,
        r,
        o = Ee(e, function (e) {
    ...
    function He(e, t) {
      var n = 1 < arguments.length && void 0 !== t && t,
        i = Pe.indexOf(e),
        r = Pe.slice(i + 1).concat(Pe.slice(0, i));
    ...
    var Qe = {
        ...
        modifiers: {
              ...
              return (
                c &&
                  ...
                  (s = (r = -1 !== ["bottom", "top"].indexOf(u))
                    ...
                    : "height"),
                  (a = {
                    start: fe({}, (o = r ? "left" : "top"), n[o]),
                    end: fe({}, o, n[o] + n[s] - i[s]),
                  }),
                  (e.offsets.popper = de({}, i, a[c]))),
                e
              );
            },
          },
          ...
          arrow: {
            ...
            fn: function (e, t) {
              ...
              a[h] - p < s[f] && (e.offsets.popper[f] -= s[f] - (a[h] - p)),
                ...
                (e.offsets.popper = he(e.offsets.popper));
              var g = a[f] + a[u] / 2 - p / 2,
          ...
          flip: {
            ...
            enabled: !0,
            fn: function (m, v) {
              if (Ce(m.instance.modifiers, "inner")) return m;
                ...
                x.forEach(function (e, t) {
                  ...
                  (s || f || g) &&
                    ...
                    (m.offsets.popper = de(
                      {},
                      m.offsets.popper,
                      xe(m.instance.popper, m.offsets.reference, m.placement)
                    )),
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var s,
                ...
                u = te(e.instance.popper),
                c = pe(u),
                f = { position: r.position },
                d = Oe(e, window.devicePixelRatio < 2 || !Le),
              ...
              return (
                (e.attributes = de({}, y, e.attributes)),
                (e.styles = de({}, f, e.styles)),
          ...
          applyStyle: {
            ...
            onLoad: function (e, t, n, i, r) {
              var o = be(r, t, e, n.positionFixed),
                s = ye(
                  n.placement,
                  o,
                  t,
    ...
    function Ue(e, t) {
      ...
      le(this, Ue),
        ...
        (this.options = de({}, Ue.Defaults, i)),
        (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
        (this.reference = e && e.jquery ? e[0] : e),
        (this.popper = t && t.jquery ? t[0] : t),
        (this.options.modifiers = {}),
        Object.keys(de({}, Ue.Defaults.modifiers, i.modifiers)).forEach(
          function (e) {
            n.options.modifiers[e] = de(
              {},
              Ue.Defaults.modifiers[e] || {},
        ...
        return (
          (e.toggle = function () {
            ...
            this._element.disabled ||
              p(this._element).hasClass(tt) ||
              ((e = p(this._menu).hasClass(nt)),
              u._clearMenus(),
              e || this.show(!0));
          }),
          (e.show = function (e) {
            if (
              ...
              if ((p(i).trigger(n), !n.isDefaultPrevented())) {
                ...
                "ontouchstart" in document.documentElement &&
                  ...
                  p(this._menu).toggleClass(nt),
                  p(i).toggleClass(nt).trigger(p.Event("shown.bs.dropdown", t));
              }
            }
          }),
          (e.hide = function () {
            ...
            this._element.disabled ||
              ...
              t.isDefaultPrevented() ||
                ...
                p(this._menu).toggleClass(nt),
                p(n).toggleClass(nt).trigger(p.Event(Je, e))));
          }),
          (e.dispose = function () {
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass("dropup")
                ? (t = p(this._menu).hasClass(it) ? "top-end" : "top-start")
                : e.hasClass("dropright")
                ? (t = "right-start")
                : e.hasClass("dropleft")
                ? (t = "left-start")
                : p(this._menu).hasClass(it) && (t = "bottom-end"),
              t
            );
          }),
                    ...
                    p(s).hasClass(nt) &&
                      ((e &&
                        ...
                        o.isDefaultPrevented() ||
                          ...
                          p(r).removeClass(nt),
                          p(s).removeClass(nt).trigger(p.Event(Je, l))))));
              }
          }),
            ...
            if (
              ...
              if (n || 27 !== e.which) {
                if (
                  ...
                  return (
                    27 === e.which && p(t.querySelector(rt)).trigger("focus"),
    ...
    p(document)
      ...
      .on(Ze + " keyup.bs.dropdown.data-api", lt._clearMenus)
      .on(Ze, rt, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
          lt._jQueryInterface.call(p(this), "toggle");
      })
      .on(Ze, ".dropdown form", function (e) {
        e.stopPropagation();
      }),
      (p.fn[$e] = lt._jQueryInterface),
      (p.fn[$e].Constructor = lt),
      (p.fn[$e].noConflict = function () {
        return (p.fn[$e] = Ye), lt._jQueryInterface;
      });
    var ut = "modal",
      ct = "bs.modal",
      ft = "." + ct,
      ...
      Dt = (function () {
        ...
        return (
            ...
            e && e.preventDefault(),
              this._isShown &&
                ...
                this._isShown &&
                  ...
                  this._setResizeEvent(),
                  p(document).off(vt),
                  p(this._element).removeClass(Tt),
                  p(this._element).off(bt),
                  p(this._dialog).off(wt),
                  n
          ...
          (e._getConfig = function (e) {
            return (e = l(l({}, ht), e)), g.typeCheckConfig(ut, e, pt), e;
          }),
          (e._triggerBackdropTransition = function () {
            ...
            if ("static" === this._config.backdrop) {
              ...
              p(this._element)
                .one(g.TRANSITION_END, function () {
                  e._element.classList.remove(Ct);
                })
          ...
          (e._setEscapeEvent = function () {
            var t = this;
            this._isShown
              ? p(this._element).on(_t, function (e) {
              ...
              : this._isShown || p(this._element).off(_t);
          }),
          (e._setResizeEvent = function () {
            var t = this;
            this._isShown
              ? p(window).on(yt, function (e) {
          ...
          (e._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                p(document.body).removeClass(xt),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
          ...
          (e._showBackdrop = function (e) {
            var t,
              n,
              i = this,
              r = p(this._element).hasClass(Et) ? Et : "";
          ...
          (r._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new r(this, t)), p(this).data(ct, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    p(document).on(
      ...
      (p.fn[ut] = Dt._jQueryInterface),
      (p.fn[ut].Constructor = Dt),
      (p.fn[ut].noConflict = function () {
        return (p.fn[ut] = dt), Dt._jQueryInterface;
      });
    var At = [
        "background",
        "cite",
            ...
            i.forEach(function (e) {
              !(function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === At.indexOf(n) ||
                    Boolean(e.nodeValue.match(jt) || e.nodeValue.match(Ot))
                  );
                for (
        ...
        return (
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              r.setAttribute("id", o),
                ...
                this.setContent(),
                this.config.animation && p(r).addClass(zt);
              var s =
          ...
          (e._enter = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              e && (t._activeTrigger["focusin" === e.type ? Yt : Xt] = !0),
              p(t.getTipElement()).hasClass(Vt) || t._hoverState === Ut
                ? (t._hoverState = Ut)
                : (clearTimeout(t._timeout),
                  (t._hoverState = Ut),
                  t.config.delay && t.config.delay.show
                    ? (t._timeout = setTimeout(function () {
                        t._hoverState === Ut && t.show();
                      }, t.config.delay.show))
                    : t.show());
          }),
          (e._leave = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              p(e.currentTarget).data(n, t)),
              e && (t._activeTrigger["focusout" === e.type ? Yt : Xt] = !1),
          ...
          (e._getConfig = function (e) {
            ...
            return (
              ...
              g.typeCheckConfig(It, e, this.constructor.DefaultType),
              e.sanitize &&
    ...
    (p.fn[It] = Kt._jQueryInterface),
      (p.fn[It].Constructor = Kt),
      (p.fn[It].noConflict = function () {
        return (p.fn[It] = Ht), Kt._jQueryInterface;
      });
    var Gt = "popover",
      Jt = "bs.popover",
      Zt = "." + Jt,
      ...
      an = (function (e) {
        ...
        return (
          ...
          (r.addAttachmentClass = function (e) {
            p(this.getTipElement()).addClass(tn + "-" + e);
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), p(this).data(Jt, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Gt] = an._jQueryInterface),
      (p.fn[Gt].Constructor = an),
      (p.fn[Gt].noConflict = function () {
        return (p.fn[Gt] = en), an._jQueryInterface;
      });
    var ln = "scrollspy",
      un = "bs.scrollspy",
      cn = "." + un,
      fn = p.fn[ln],
      dn = { offset: 10, method: "auto", target: "" },
      ...
      bn = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            ...
            return (
              "string" !=
                typeof (e = l(l({}, dn), "object" == typeof e && e ? e : {}))
                  .target &&
                g.isElement(e.target) &&
                ((t = p(e.target).attr("id")) ||
                  ((t = g.getUID(ln)), p(e.target).attr("id", t)),
                (e.target = "#" + t)),
              g.typeCheckConfig(ln, e, hn),
              e
            );
          }),
          ...
          (e._activate = function (t) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(pn),
                n.addClass(pn))
              : (n.addClass(pn),
                n
                  .parents(gn)
                  .prev(mn + ", " + vn)
                  .addClass(pn),
                n.parents(gn).prev(".nav-item").children(mn).addClass(pn)),
    ...
    p(window).on("load.bs.scrollspy.data-api", function () {
      ...
      (p.fn[ln] = bn._jQueryInterface),
      (p.fn[ln].Constructor = bn),
      (p.fn[ln].noConflict = function () {
        return (p.fn[ln] = fn), bn._jQueryInterface;
      });
    var _n = "bs.tab",
      wn = p.fn.tab,
      xn = "active",
        ...
        return (
          (e.show = function () {
            ...
            (this._element.parentNode &&
              ...
              t &&
                ((i = "UL" === t.nodeName || "OL" === t.nodeName ? Tn : En),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = p(this),
                t = e.data(_n);
              if (
                (t || ((t = new i(this)), e.data(_n, t)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
                t[n]();
    ...
    p(document).on(
      ...
      function (e) {
        e.preventDefault(), Cn._jQueryInterface.call(p(this), "show");
      }
    ),
      (p.fn.tab = Cn._jQueryInterface),
      (p.fn.tab.Constructor = Cn),
      (p.fn.tab.noConflict = function () {
        return (p.fn.tab = wn), Cn._jQueryInterface;
      });
    var Sn = "toast",
      kn = "bs.toast",
      Dn = "." + kn,
        ...
        return (
          (e.show = function () {
            ...
            p(this._element).trigger(i),
              i.isDefaultPrevented() ||
                ...
                (e = function () {
                  n._element.classList.remove(On),
          ...
          (e.dispose = function () {
            clearTimeout(this._timeout),
              ...
              p(this._element).off(Nn),
              p.removeData(this._element, kn),
              (this._element = null),
              (this._config = null);
          }),
          (e._getConfig = function (e) {
            return (
              (e = l(
                l(l({}, In), p(this._element).data()),
                "object" == typeof e && e ? e : {}
              )),
              g.typeCheckConfig(Sn, e, this.constructor.DefaultType),
              e
            );
          }),
          (e._setListeners = function () {
            var e = this;
            p(this._element).on(Nn, '[data-dismiss="toast"]', function () {
              return e.hide();
            });
          }),
          (e._close = function () {
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (t ||
                  ((t = new i(this, "object" == typeof n && n)), e.data(kn, t)),
                "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Sn] = qn._jQueryInterface),
      (p.fn[Sn].Constructor = qn),
      (p.fn[Sn].noConflict = function () {
        return (p.fn[Sn] = An), qn._jQueryInterface;
      }),
      (e.Alert = c),
      (e.Button = b),
      (e.Carousel = O),
