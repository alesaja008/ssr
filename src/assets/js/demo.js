jQuery(document).ready(function ($) {
  ...
  $(".color-1").click(function () {
    $("body").removeClass(
      "second-color-styles third-color-styles fourth-color-styles"
    );
  ...
  $(".color-2").click(function () {
    $("body").removeClass(
      "first-color-styles third-color-styles fourth-color-styles"
    );
  ...
  $(".color-3").click(function () {
    $("body").removeClass(
      "second-color-styles first-color-styles fourth-color-styles"
    );
  ...
  $(".color-4").click(function () {
    $("body").removeClass(
      "second-color-styles first-color-styles third-color-styles "
    );
